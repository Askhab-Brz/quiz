...
def add_question(request):
    ...
    if request.method == "POST":
        ...
        form = QuestionForm()
    return render(
        request, "quizez/add_question.html", {"form": form, "questions": questions}
    )
...
def add_options(request, myid):
    ...
    return render(
        request, "quizez/add_options.html", {"formset": formset, "question": question}
    )
